...
namespace SideCarCore.Controllers
{
    ...
    public class MessagePublisherController : ControllerBase
    {
        ...
        public MessagePublisherController(IKafkaSettings kafkaSettings)
        {
        ...
        public void PaymentProducer([FromBody] PaymentContext paymentContext)
        {
            ...
            {
            Publisher.PushMessage(_kafkaSettings.ConnectionString, paymentContext, _kafkaSettings.Topicname[0].ToString());
